utilizando herramientas de inteligencia artificial como ChatGPT y creamos un conjunto de datos en un archivo JavaScript. El resultado obtenido es una página web  que visualiza los datos de las películas de animación japonesa, brindando la capacidad de aplicar filtros, ordenar la información y realiza cálculos estadísticos.
...
<img id="sitio" src="./src/img/Kaonashi.jpg" width="600px" /><br>